...
//            bindingResult.addError(new FieldError("item", "price", "가격은 1,000 ~ 1,00,000원까지만 허용됩니다."));
//        }
...
//                bindingResult.addError(new ObjectError("item", "(가격)X(수량)의 값은 10,000원 이상이어야 합니다. 현재 값 = " + resultPrice));
//            }
//        }
//
//        //검증 실패 시 다시 입력 폼으로
...
//        }
//        if(item.getPrice()==null || item.getPrice()<1000 || item.getPrice()>1000000){
//            bindingResult.addError(new FieldError("item", "price",item.getPrice(),false,null,null, "가격은 1,000 ~ 1,00,000원까지만 허용됩니다."));
//        }
//        if(item.getQuantity()==null || item.getQuantity()>=9999){
...
//            int resultPrice=item.getPrice()*item.getQuantity();
//            if(resultPrice<10000){
//                bindingResult.addError(new ObjectError("item",null,null, "(가격)X(수량)의 값은 10,000원 이상이어야 합니다. 현재 값 = " + resultPrice));
//            }
//        }
//
//        //검증 실패 시 다시 입력 폼으로
